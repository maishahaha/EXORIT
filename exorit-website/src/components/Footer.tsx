    ...
    <footer className="bg-dark text-white py-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          >
            <Link to="/" className="text-2xl font-bold text-white mb-4 block">EXORIT</Link>
          ...
          >
            ...
            <address className="not-italic">
              <p className="flex items-start space-x-3 text-gray-300 mb-4">
                ...
                <span>123 Tech Park, Innovation Street, CA 94043, USA</span>
              </p>
              <p className="flex items-start space-x-3 text-gray-300 mb-4">
                <svg className="h-6 w-6 text-primary flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span>contact@exorit.com</span>
              </p>
